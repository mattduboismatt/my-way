module DurationAlgorithm
  ...
  def self.run(route)
    ...
    when 'driving'
      ...
      duration_exp > 100 ? 100 : duration_exp
    when 'bicycling'
      duration_exp = ((-1.0/45)* (duration) + 100).to_i
    when 'divvy'
      duration_exp = ((-1.0/45)* (duration) + 100).to_i - 3
    when 'bus'
    ...
    when 'uber'
      duration_exp = (4.224E-15*duration**5 - 4.169E-11*duration**4 + 1.398E-7*duration**3 - 1.771E-4*duration**2 + 0.084*duration+ 18.634).to_i - (wait_time/30).to_i
      duration_exp > 100 ? 100 : duration_exp
    when 'cab'
      duration_exp = (4.224E-15*duration**5 - 4.169E-11*duration**4 + 1.398E-7*duration**3 - 1.771E-4*duration**2 + 0.084*duration+ 18.634).to_i - (wait_time/30).to_i
      duration_exp > 100 ? 100 : duration_exp
